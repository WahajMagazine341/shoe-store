...
export const Home = () => {
  ...
  const shoes = [
    ...
    //38125134053551:
    {
      name:"M6322",
      price:"PKR-4000",
      img:"https://cdn.shopify.com/s/files/1/0083/8405/3305/products/01_69598565-d4a1-4f11-adb6-6ad36f37448d_large.jpg?v=1611065927"
    },
    //38125159350447:
    {
      name:"M6372",
  ...
  return (
   <div>
       <Typography style={{ marginTop:"3%",marginLeft:"27%", fontFamily:"cursive"}} variant="h2" gutterBottom> Welcome to Shoe Store</Typography>
        <Grid
        container
        spacing={0}
      ...
      >
        ...
        <Grid item xs={10} md={5} alignItems="center" justify="center">
           <Paper className={classes.paper} elevation={0}>
          <img
            style={{ width: "400px", marginLeft: "15%" }}
            src={obj.img}
            alt="test"
          />
           </Paper>
